(function () {
  ...
  var SpriteGameObject = SFB.SpriteGameObject = function (options) {
      // if (this.sprite) {
        this.sprite = options.sprite;
      // }

      this.origin = SFB.Vector2.zero;
      this.mirror = false;
      this._sheetIndex = 0;
      SFB.MovingObject.call(this, options);
  }

  SFB.Utils.inherits(SFB.SpriteGameObject, SFB.MovingObject);


  // SpriteGameObject.prototype = Object.create(SFB.GameObject.prototype);
  ...
  Object.defineProperty(SpriteGameObject.prototype, "screenCenterX",
      {
          get: function () {
              return (SFB.Game.size.x - this.width) / 2 + this.origin.x;
          }
      });
  ...
  Object.defineProperty(SpriteGameObject.prototype, "screenCenterY",
      {
          get: function () {
              return (SFB.Game.size.y - this.height) / 2 + this.origin.y;
          }
      });
  ...
  Object.defineProperty(SpriteGameObject.prototype, "screenCenter",
      {
          get: function () {
              return SFB.Game.size.subtract(this.size).divideBy(2).addTo(this.origin);
          }
      });
  ...
  Object.defineProperty(SpriteGameObject.prototype, "boundingBox",
      {
          get: function () {
              var leftTop = { x: this.xpos, y: this.ypos }
              return new SFB.Rectangle(leftTop.x, leftTop.y, this.width, this.height);
          }
      });
