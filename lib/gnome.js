(function() {
  ...
  SFB.Gnome.prototype.draw = function(ctx) {
    ...
    ctx.beginPath();
		ctx.fillStyle = "white";
    ctx.fillRect( this.xpos - 65, this.ypos - 100, 130, 30 );
		ctx.fill();
		ctx.closePath();

    ctx.beginPath();
		ctx.fillStyle = "lightcoral";
    ctx.fillRect( this.xpos - 60, this.ypos - 95, 120, 20 );
		ctx.fill();
		ctx.closePath();
		
    ctx.beginPath();
		ctx.fillStyle = "red";
    ctx.fillRect( this.xpos - 60, this.ypos - 95, 120 * (this.health / 100), 20 );
		ctx.fill();
		ctx.closePath();
		...
		ctx.fillStyle = "black"
		ctx.fillText("Health: " + this.health, this.xpos - 55, this.ypos - 78);
	}
