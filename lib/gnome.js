(function() {
 ...
 if (this.onGround) {
  ...
  SFB.Gnome.prototype.fireFart = function() {
    ...
    var fart = new SFB.Fart({ gnome: this, xpos: this.xpos, ypos: this.ypos, xvel: xvel, yvel: this.yvel, game: this.game, gnome_id: this.id });
  };
  ...
  SFB.Gnome.prototype.fireSpecialFart = function() {
    ...
    if (this.specialFart === "Bounce") {
      var fart = new SFB.FartBounce({ xpos: this.xpos, ypos: this.ypos, xvel: xvel, yvel: this.yvel, game: this.game, gnome_id: this.id });
    } else if (this.specialFart === "Flame") {
      var fart = new SFB.FartFlame({ game: this.game, gnome_id: this.id, gnome: this });
    } else if (this.specialFart === "Mine") {
      var fart = new SFB.FartMine({ xpos: this.xpos, ypos: this.ypos, xvel: xvel, game: this.game, gnome_id: this.id, gnome: this });
    }
