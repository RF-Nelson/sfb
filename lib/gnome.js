(function() {
  ...
  SFB.Gnome = function (attrs) {
    ...
    this.loadAnimation(attrs.game.sprites.idle, "idle", true);
    this.loadAnimation(attrs.game.sprites.run, "run", true, 0.025);
  ...
  SFB.Gnome.prototype.draw = function(ctx) {
    ...
    // debugger
    // window.game.drawImage(this._current, ctx, this.xpos, this.ypos - 130)
    SFB.AnimatedObject.prototype.update.call(this, 20);
