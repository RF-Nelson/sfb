(function() {
  ...
  SFB.Gnome.prototype.fireSpecialFart = function() {
    ...
    // if (this.specialFart === "Bounce") {
      // var fart = new SFB.BounceFart({ xpos: this.xpos, ypos: this.ypos, xvel: xvel, yvel: this.yvel, game: this.game, gnome_id: this.id });
    // } else if (this.specialFart === "Flame") {
      var fart = new SFB.FlameFart({ xpos: this.xpos, ypos: this.ypos, xvel: xvel, yvel: this.yvel, game: this.game, gnome_id: this.id, gnome: this });
