(function() {
  ...
  SFB.Gnome = function (attrs) {
    ...
    this.idleSprite = loadSprite('./sprites/gnome.png');
    this.loadAnimation(this.idleSprite, "idle", true);

    this.runSprite = loadSprite('./sprites/gnome@13.png');
    this.loadAnimation(this.runSprite, "run", true, 0.025);
