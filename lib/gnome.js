(function() {
 ...
 if (this.onGround) {
  ...
  SFB.Gnome.prototype.fartPack = function () {
    if (this.fartPackMeter >= 5 && !this.fartPacking) {
      this.fartPacking = true;
      this.yvel =  -5;
      this.fartPackingTimer = 1000;
      this.fartPackMeter -= 5;
    }
  }
  ...
  SFB.Gnome.prototype.handleHit = function (strength) {
    this.health -= (strength / this.toughness);
  ...
  SFB.Gnome.prototype.drawHealthMeter = function(ctx){
    ...
    ctx.beginPath();
    ctx.fillStyle = "red";
    ctx.fillRect( this.xpos - 20, this.ypos - 155, 120 * (this.healthMeter / 100), 20 );
    ctx.fill();
    ctx.closePath();
    ...
    ctx.fillStyle = "black"
    ctx.fillText("HEALTH", this.xpos + 5, this.ypos - 138);
  ...
  SFB.Gnome.prototype.drawBeanMeter = function(ctx){
    ...
    ctx.beginPath();
    ctx.fillStyle = "white";
    ctx.fillRect( this.xpos - 25, this.ypos - 190, 130, 30 );
    ctx.fill();
    ctx.closePath();

    ctx.beginPath();
    ctx.fillStyle = "lightcoral";
    ctx.fillRect( this.xpos - 20, this.ypos - 185, 120, 20 );
    ctx.fill();
    ctx.closePath();

    ctx.beginPath();
    ctx.fillStyle = "red";
    ctx.fillRect( this.xpos - 20, this.ypos - 185, 120 * (this.beanMeter / 100), 20 );
    ctx.fill();
    ctx.closePath();
    ...
    ctx.font="18px Verdana";
    ctx.fillStyle = "black"
    ctx.fillText("BEAN", this.xpos + 15, this.ypos - 168);
