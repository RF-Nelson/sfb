(function() {
  ...
  SFB.Gnome.prototype.fireSpecialFart = function() {
    ...
    if (this.specialFart === "Bounce") {
      var fart = new SFB.FartBounce({ gnome: this, xpos: this.xpos, ypos: this.ypos, xvel: xvel, yvel: this.yvel, game: this.game, gnome_id: this.id, team: this.team, strength: 5 });
