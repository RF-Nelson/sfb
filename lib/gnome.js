(function() {
  ...
  SFB.Gnome = function (attrs) {
    ...
    this.loadAnimation(attrs.game.sprites.jumpUpLeft, "jumpUpLeft", false, 0.025);
    this.loadAnimation(attrs.game.sprites.jumpUpRight, "jumpUpRight", false, 0.025);
    this.loadAnimation(attrs.game.sprites.jumpDownLeft, "jumpDownLeft", false, 0.06);
    this.loadAnimation(attrs.game.sprites.jumpDownRight, "jumpDownRight", false, 0.06);
