(function() {
 ...
 if (this.onGround) {
  ...
  SFB.Gnome.prototype.handleBean = function () {
    this.beanPower =  this.beanPower > 99 ? this.beanPower = 100 : this.beanPower += 25
  };
  ...
  SFB.Gnome.prototype.drawHealthBar = function(ctx){
  ...
  SFB.Gnome.prototype.drawPowerBar = function(ctx){
    var canvasScale = SFB.GameView.prototype.scale;
    scale = typeof scale !== 'undefined' ? scale : 1;
    ...
    ctx.beginPath();
    ctx.fillStyle = "red";
    ctx.fillRect( this.xpos - 20, this.ypos - 215, 120 * (this.powerMeter / 100), 20 );
    ctx.fill();
    ctx.closePath();
    ...
    ctx.font="18px Verdana";
    ctx.fillStyle = "black"
    ctx.fillText("POWER UP", this.xpos - 8, this.ypos - 198);
  ...
  SFB.Gnome.prototype.drawBeanBar = function(ctx){
    var canvasScale = SFB.GameView.prototype.scale;
    scale = typeof scale !== 'undefined' ? scale : 1;
    ...
    ctx.beginPath();
    ctx.fillStyle = "red";
    ctx.fillRect( this.xpos - 20, this.ypos - 185, 120 * (this.beanPower / 100), 20 );
    ctx.fill();
    ctx.closePath();
