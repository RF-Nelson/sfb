(function() {
  ...
  SFB.FlameFart = function (options) {
    ...
    SFB.Utils.inherits(SFB.FlameFart, SFB.Fart);

    SFB.FlameFart.prototype.move = function() {
  ...
  // SFB.FlameFart.prototype.collideWith = function (gnome) {
  ...
  // };
  //
  // SFB.FlameFart.prototype.draw = function (ctx) {
