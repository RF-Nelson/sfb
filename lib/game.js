(function () {
  ...
  Game.prototype.addGnomes = function (numPlayers) {
    var sprites = {}
    sprites.run = this.loadSprite('./sprites/gnome@13.png');
    sprites.idle = this.loadSprite('./sprites/gnome.png');
    var gnome1 = new SFB.Gnome({game: this, xpos: 100, ypos: 569, id: 1, color: "darkgreen", sprites: sprites})
    var gnome2 = new SFB.Gnome({game: this, xpos: 940, ypos: 569, id: 2, color: "blue", sprites: sprites})
