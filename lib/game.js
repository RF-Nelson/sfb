(function () {
  ...
  var Game = SFB.Game = function (numPlayers) {
    ...
    this.playerStartingSettings = [
      { gnomeId: 1, xpos: 100, ypos: (SFB.Game.DIM_Y - 131), color: "blue", facing: "Right", specialKey: "q" },
      { gnomeId: 2, xpos: 1640, ypos: (SFB.Game.DIM_Y - 131), color: "orange", facing: "Left", specialKey: "space" },
      { gnomeId: 3, xpos: 300, ypos: (SFB.Game.DIM_Y - 131), color: "purple", facing: "Right", specialKey: "v" },
      { gnomeId: 4, xpos: 1340, ypos: (SFB.Game.DIM_Y - 131), color: "green", facing: "Right", specialKey: "x" }
    ];
  ...
  Game.prototype.addGnome = function (gnome, gnomeIndex) {
    ...
    var newGnome = new SFB.Gnome({game: this, xpos: gnomeBasic.xpos, ypos: gnomeBasic.ypos, id: gnomeBasic.gnomeId, key: gnomeBasic.specialKey, color: gnomeBasic.color, facing: gnomeBasic.facing, onGround: true, speed: gnomeSpeed, toughness: gnomeToughness, team: gnome.attrs.playerTeam, specialFart: gnome.attrs.fart });
