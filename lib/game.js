(function () {
  ...
  Game.prototype.addGnomes = function (numPlayers) {
    var gnome1 = new SFB.Gnome({game: this, xpos: 100, ypos: 669, id: 1, color: "darkgreen", facing: "Right", onGround: true });
    var gnome2 = new SFB.Gnome({game: this, xpos: 940, ypos: 669, id: 2, color: "blue", facing: "Left", onGround: true });
    this.gnomes = [].concat(gnome1).concat(gnome2)
  };

  Game.prototype.addBeans = function () {
    this.beanCounter += 1;
    if (this.beanCounter > 200 && this.beans.length < 2) {
  ...
  Game.prototype.checkPowerCollisions = function () {
    ...
    this.gnomes.forEach(function (object1) {
      that.beans.forEach(function (object2) {
        if (object1.isCollidedWith(object2)) {
          if (object2 instanceof SFB.Bean) {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    } else if (this.gnomes[1].beanCount >= 1) {
