(function () {
  ...
  Game.prototype.drawScreen = function (ctx) {
    ...
    var flamethrowerCanvas = document.getElementById('flamethrower');
     if (flamethrowerCanvas && window.flamethrowerEffect) {
      ...
      // window.emitters.forEach(function (emitter) {
      if (window.flamethrowerEffect._started) {
        window.flamethrowerEffect.update(window.game.delta/1000).render()
      }
