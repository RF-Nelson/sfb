(function () {
  ...
  Game.prototype.addGnomes = function (numPlayers) {
    var gnome1 = new SFB.Gnome({game: this, xpos: 100, ypos: 669, id: 1, color: "darkgreen", facing: "Right" })
    var gnome2 = new SFB.Gnome({game: this, xpos: 940, ypos: 669, id: 2, color: "blue", facing: "Left" })
