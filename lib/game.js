(function () {
  ...
  var Game = SFB.Game = function (numPlayers) {
    ...
    this.playerStartingSettings = [
      { gnomeId: 1, xpos: 100, ypos: (SFB.Game.DIM_Y - 131), color: "purple", facing: "Right" },
      ...
      { gnomeId: 4, xpos: 1340, ypos: (SFB.Game.DIM_Y - 131), color: "purple", facing: "Right" }
    ];
  ...
  Game.prototype.draw = function (ctx) {
    ...
    if (canvas && window.emitter) {
      ...
      // window.emitters.forEach(function (emitter) {
        emitter.update(window.game.delta/1000).render()
      // })
