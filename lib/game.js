(function () {
  ...
  Game.prototype.handleFartTimer = function () {
    ...
    this.farts.forEach(function (fart) {
      if (fart instanceof SFB.BounceFart || fart instanceof SFB.FlameFart ) {
          fart.timeLeft -= 20;
          if (fart.timeLeft < 1) {
            if (fart instanceof SFB.FlameFart && !(key.isPressed("s"))) {
  ...
  Game.prototype.checkGnomeStaticCollisions = function(){
    ...
    this.gnomes.forEach(function (object1) {
      ...
      that.scene.scenery.forEach(function (object2) {
          if (SFB.Utils.checkGnomeStaticCollide(object1, object2)) {
  ...
  Game.prototype.checkFartStaticCollisions = function(){
    var that = this;
    this.farts.forEach(function (object1) {
      if (object1 instanceof SFB.BounceFart) {
        that.scene.scenery.forEach(function (object2) {
          if (SFB.Utils.checkFartStaticCollide(object1, object2)[1]) {
            object1.handleBounce('side');
          } else if (SFB.Utils.checkFartStaticCollide(object1, object2)[0]) {
            object1.handleBounce('ground');
          }
        });
      }
    });
