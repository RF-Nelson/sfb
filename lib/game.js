(function () {
  ...
  Game.prototype.setParticles = function () {
    // new SFB.FireBall(-1)
  }
  ...
  //     window.FireBalls.forEach(function (emitter) {
  //       if (emmiter._started) {
  //         emitter.effect.update(window.game.delta/1000).render()
  //       }
  ...
  Game.prototype.draw = function (ctx) {
    ...
    //     flamethrowerCtx.save()
    //     flamethrowerCtx.clearRect(0, 0, Game.DIM_X, Game.DIM_Y);
    //     if (emitter.effect && emitter.effect._started) {
    //       emitter.effect.update(window.game.delta/1000).render()
    //     }
    //     flamethrowerCtx.scale(scale * canvasScale.x, scale * canvasScale.y)
    //     flamethrowerCtx.restore()
