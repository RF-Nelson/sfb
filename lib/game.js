(function () {
  ...
  var Game = SFB.Game = function () {
    ...
    // this.scenery = this.scene.scenery;
    this.farts = [];
  ...
  Game.prototype.addGnomes = function (numPlayers) {
    var gnome1 = new SFB.Gnome({game: this, xpos: 100, ypos: 700, id: 1})
    var gnome2 = new SFB.Gnome({game: this, xpos: 900, ypos: 700, id: 2})
  ...
  Game.prototype.checkCollisions = function () {
    ...
    this.movingObjects().forEach(function (object1) {
