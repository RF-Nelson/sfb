(function () {
  ...
  Game.prototype.addGnomes = function (numPlayers) {
    var gnome1 = new SFB.Gnome({game: this, xpos: 100, ypos: (SFB.Game.DIM_Y - 131), id: 1, color: "darkgreen", facing: "Right" })
    var gnome2 = new SFB.Gnome({game: this, xpos: 940, ypos: (SFB.Game.DIM_Y - 131), id: 2, color: "blue", facing: "Left" })
