(function () {
  ...
  Game.prototype.addGnome = function (gnome, gnomeIndex) {
    ...
    var newGnome = new SFB.Gnome({game: this, xpos: gnomeBasic.xpos, ypos: gnomeBasic.ypos, id: gnomeBasic.gnomeId, color: gnomeBasic.color, facing: gnomeBasic.facing, onGround: true, speed: gnomeSpeed, toughness: gnomeToughness, specialFart: gnome.attrs.fart });
