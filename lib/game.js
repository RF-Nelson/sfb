(function () {
  ...
  Game.prototype.addGnome = function (gnome, gnomeIndex) {
    ...
    var newGnome = new SFB.Gnome({game: this, xpos: gnomeBasic.xpos, ypos: gnomeBasic.ypos, id: gnomeBasic.gnomeId, key: gnomeBasic.specialKey, color: gnomeBasic.color, facing: gnomeBasic.facing, onGround: true, speed: gnomeSpeed, toughness: gnomeToughness, team: gnome.attrs.playerTeam, specialFart: gnome.attrs.fart, livesPos: livesPos });
  ...
  Game.prototype.draw = function (ctx) {
    ...
    for(var i = 1; i <= players.length; i ++) {
      player = players[i-1];
        ...
        // ctx.fillText("Player " + i + " Lives: " + player.lives, 40, 1060);
