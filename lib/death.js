  (function() {
    ...
    SFB.Death = function (gnome) {
      ...
      if (window.game) {
        if (gnome.color === "blue") {
          bodyParts[7].loadAnimation(window.game.sprites.blue, "anim", true, 0.036)
        } else if (gnome.color === "green") {
          bodyParts[7].loadAnimation(window.game.sprites.green, "anim", true, 0.036)
        } else if (gnome.color === "purple") {
          bodyParts[7].loadAnimation(window.game.sprites.purple, "anim", true, 0.036)
        } else {
          bodyParts[7].loadAnimation(window.game.sprites.orange, "anim", true, 0.036)
        }
        ...
        for (var i = 0; i < window.game.parts.length; i++) {
          ...
          bodyParts[i].loadAnimation(window.game.parts[i], "anim", true, 0.036)
