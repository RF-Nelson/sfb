(function() {
  ...
  var Rectangle = SFB.Rectangle = function (x, y, w, h) {
    ...
    SFB.Animation.prototype.flameThrower = function (xpos, ypos) {
      ...
      var ctx	= canvas.getContext( '2d' );
      canvas.width = SFB.Game.DIM_X * canvasScale.x
      canvas.height = SFB.Game.DIM_Y * canvasScale.y
    ...
    loadTremulousParticles(files, function(images){
      ...
      var ctx = document.getElementById('fireworks').getContext( '2d' );
      ...
      window.flameEmitter	= Fireworks.createEmitter({nParticles : 400})
        .effectsStackBuilder()
          ...
          .velocity(Fireworks.createShapeSphere(0, 0, 0, 150))
          .acceleration({
            effectId	: 'gravity',
