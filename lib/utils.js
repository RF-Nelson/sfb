(function () {
  ...
  var checkGnomeSideStaticCollide = Utils.checkGnomeSideStaticCollide = function(movingObject, staticObject, mo, so) {
    ...
    // if (((so.bottom > mo.top) && (so.bottom < mo.bottom)) || ((so.top > mo.top) && (so.top < mo.bottom - 6))) {
    //   if (((so.right > mo.left) && (so.right < mo.right)) || ((so.left > mo.left) && (so.left < mo.right))) {
    //     if (movingObject.facing === "Right" && movingObject.xvel > 1) {
    //       (movingObject.xvel = - 1);
    //     } else {
    //       movingObject.xvel = -2;
    //     }
    //   }
    // } else if ((so.bottom > mo.top && so.bottom < mo.bottom) || (so.top > mo.top && so.top < mo.bottom - 6)) {
    //   if ((so.right > mo.left && so.right < mo.right) || (so.left > mo.left && so.left < mo.right)) {
    //     if (movingObject.facing === "Left" && movingObject.xvel < - 1) {
    //       (movingObject.xvel = 1);
    //     } else {
