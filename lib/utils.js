(function () {
  ...
  var inherits = Utils.inherits = function(childClass, parentClass){
	...
	var checkStaticCollide = Utils.checkGnomeStaticCollide = function(movingObject, staticObject){
  ...
  var checkStaticCollide = Utils.checkFartStaticCollide = function(movingObject, staticObject){
