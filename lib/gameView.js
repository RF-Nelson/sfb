(function () {
  ...
  GameView.prototype.bindKeyHandlers = function () {
    ...
    key("a", function () { console.log("gnome1 run left");});//gnome1.run([0,1]) });
    key("w", function () { console.log("gnome1 jump");});//gnome1.jump() });
    key("d", function () { console.log("gnome1 run right");});//gnome1.run([0,-1]) });
    key("s", function () { console.log("gnome1 fart");});//gnome1.fart!() });
