(function () {
  ...
  if(key.isPressed("f")) gnome1.fireSilent();
  ...
  if(key.isPressed("return")) gnome2.fireSilent();
  ...
  Object.defineProperty(SFB.GameView.prototype, "scale",
      {
          get: function () {
              return new SFB.Vector2(this._canvas.width / SFB.Game.DIM_X,
                  this._canvas.height / SFB.Game.DIM_Y);
          }
      });
